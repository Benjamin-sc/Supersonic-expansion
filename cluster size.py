...
@author: Benjamin Tomasetti (2022)
"""
...
class GUI_Cluster:
    def __init__(self, parent):
        ...
        self.containerLoad    = LabelFrame(parent,text = "Average cluster size formed by gas expansion", bg="white", fg="red", font='25')            # Create LOAD container
        ...
        #add child
        self.tree.insert(parent='', index='end', iid=3, text="Ar", values=(40, 1646))
        self.tree.move('3', '0', '0')
        self.tree.insert(parent='', index='end', iid=4, text="He", values=(4, 3.85 ))
        self.tree.move('4', '0', '0')
        self.tree.insert(parent='', index='end', iid=5, text="N2", values=(28, ))
...
root = Tk()
root.wm_title("Average cluster size determination")                                        # Set window title
#root.iconbitmap("icon.ico")                                                     # Set icon bitmap
root.geometry("1300x700")
#root.configure(bg="#263D42")
gui_cluster = GUI_Cluster(root)                                                   # Instantiate the class GUI_BOS
root.mainloop()